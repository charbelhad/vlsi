...
#
# A recommended scenario naming convention is the following:
#
...
rm_source -file [dcrm_mcmm_filename ${DCRM_CONSTRAINTS_INPUT_FILE} ${scenario}]
...
rm_source -optional -file [dcrm_mcmm_filename ${DCRM_MV_SET_VOLTAGE_INPUT_FILE} ${scenario}]
