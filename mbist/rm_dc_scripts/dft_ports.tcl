##########################################################################################
# DFT ports creation for Design Compiler methodology scripts
...
puts "RM-info: Working on DFT_CONFIGURATION = $DFT_CONFIGURATION"
...
##    create_port snps_pipelined_scan_clock
  ...
  THIRDPARTY-CODEC_COREWRAP-MM_TP_SCAN {
    ...
    # NOTE: This configuration is provided as a template but depends on block specifics. Make a copy of this and the scan_configuration.tcl file
